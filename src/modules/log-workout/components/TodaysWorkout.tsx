...
import { Routine, RoutineExercise } from "@modules/log-workout/actions/log-workout.actions";
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  ...
                  {todayWorkout.items.length > 3 && (
                    <div className="text-sm text-muted-foreground">+{todayWorkout.items.length - 3} ejercicios más...</div>
                  )}
                </div>
                <WorkoutSelector
