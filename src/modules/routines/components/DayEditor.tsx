      ...
      <CardHeader className='flex flex-row items-center justify-between space-y-0'>
        <div className='mr-4 flex-1'>
          {isEditingName ? (
            <Input
              ...
              maxLength={50}
              className='border-primary border-b-2 p-2 text-2xl font-bold focus-visible:ring-0'
            />
          ) : (
        ...
        <div className='flex items-center gap-2'>
          ...
          <Button
            ...
            title={
              !canDeleteDay
                ? 'Eliminá los ejercicios de este día para poder borrarlo'
                : 'Eliminar día'
            }
          >
