...
export default function RoutineDetailsFeature({ initialRoutine }: RoutineDetailsFeatureProps) {
        ...
        {isArchived && (
          <Alert variant="default">
            ...
            <AlertDescription className="flex items-center justify-between">
              <span>Esta rutina está archivada y no aparecerá en la lista principal.</span>
