  ...
  return (
    <div className="flex-1 space-y-6 p-6">
      ...
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">Aquí tienes un resumen de tu progreso y entrenamientos recientes.</p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {data.weekSessions >= 3 ? "+1 desde la semana pasada" : "Objetivo: 3 por semana"}
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{data.monthVolume.toLocaleString()}</div>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Por sesión de entrenamiento</p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Card>
          <CardHeader>
            ...
            <CardDescription>{todayWorkout ? todayWorkout.name : "Día de descanso programado"}</CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-4">
            {data.recentPRs.length > 0 ? (
              ...
              <div className="text-center py-6 text-muted-foreground">
                ...
                <p className="text-sm">Comienza a entrenar para ver tu progreso</p>
              </div>
            )}
